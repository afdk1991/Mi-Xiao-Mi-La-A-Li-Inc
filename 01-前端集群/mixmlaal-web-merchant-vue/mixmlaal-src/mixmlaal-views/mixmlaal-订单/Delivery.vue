  ...
  <div class="delivery-order">
    <el-card>
        ...
        <el-form :inline="true" :model="filterForm" class="demo-form-inline">
          <el-form-item label="订单状态">
            <el-select v-model="filterForm.status" placeholder="选择状态">
              ...
              <el-option label="待取货" value="pending_pickup"></el-option>
      ...
      <el-table :data="orderList" style="width: 100%">
        ...
        <el-table-column prop="deliveryAddress" label="配送地址" width="200">
          <template #default="scope">
            {{ scope.row.deliveryAddress.slice(0, 20) }}{{ scope.row.deliveryAddress.length > 20 ? '...' : '' }}
          </template>
        </el-table-column>
        ...
        <el-table-column prop="deliveryPerson" label="配送员" width="120"></el-table-column>
...
export default {
  ...
  setup() {
    ...
    const mockOrders = [
      ...
      {
        id: 3,
        orderNo: 'D202604230003',
        userName: '王五',
        deliveryAddress: '北京市西城区西单大街120号',
        totalAmount: 39.99,
        status: 'delivering',
      ...
      {
        id: 4,
        orderNo: 'D202604230004',
        userName: '赵六',
        deliveryAddress: '北京市东城区王府井大街99号',
        totalAmount: 25.99,
        status: 'completed',
