...
const authApi = {
  sendCode: data => post('/auth/send-code', data),

  register: data => post('/auth/register', data),

  login: data => post('/auth/login', data),

  thirdPartyLogin: data => post('/auth/third-party-login', data),
  ...
  bindEmail: data => post('/auth/bind-email', data),
...
const api = {
  ...
  login: authApi.login,
  thirdPartyLogin: authApi.thirdPartyLogin,
};
